(ns mieza.benchmarks.meanings.initializations.sampling
  "Quick benches to optimize speed of sampling during the initialization step."
  (:require
   [clj-async-profiler.core :as prof]
   [criterium.core :refer [quick-bench]]
   [mieza.meanings.distances :refer [get-distance-fn]]
   [mieza.meanings.initializations.afk :refer [qx-column-name]]
