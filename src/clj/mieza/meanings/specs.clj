(ns mieza.meanings.specs
  (:require
   [clojure.spec.alpha :as s]
   [clojure.spec.gen.alpha :as gen]
   [mieza.meanings.testbeds.gaussian-hyperspheres :refer [gen-dataset]]
   [mieza.meanings.distances :refer [distance-keys]]
   [mieza.meanings.persistence :refer [formats]]
   [mieza.meanings.initializations.core :refer [initialization-keys]]
   [mieza.file.utils :as futils]
...
(s/def ::configuration
  (s/keys :req-un
          [:mieza.meanings.specs/k
           string?
           string?
           string?
           :mieza.meanings.specs/format-key
           :mieza.meanings.specs/init-key
...
(s/def ::cluster-result
  (s/keys :req-un 
          [:mieza.meanings/filename
           :mieza.meanings/filename
           :mieza.meanings/format-key
           :mieza.meanings/cost
           :mieza.meanings/cluster-result-configuration]))
