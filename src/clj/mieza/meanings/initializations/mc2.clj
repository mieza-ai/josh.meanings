(ns mieza.meanings.initializations.mc2
...
(def t-datasets :mieza.meanings.specs/datasets)
(def t-cluster-count :mieza.meanings.specs/k)
(def t-chain-length :mieza.meanings.specs/m)
(def t-point :mieza.meanings.specs/point)
